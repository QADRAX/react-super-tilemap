...
import { TilemapActions, _setCameraMotionQueue, _setCameraPosition, _setCurrentZoom } from "../../Context/TilemapContext.actions";
...
export function useTilemapContextActions(
    ...
    const centerCamera = useCallback(
        () => {
            ...
            const centeredCameraPosition = getCenteredCameraPosition(
                state.canvasSize, 
                computed.mapSize
            );
