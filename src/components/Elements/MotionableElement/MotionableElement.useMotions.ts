...
export function useMotions(
    ...
    const [currentElementMotion, setCurrentElementMotion] = useState<CurrentMotion<TilePosition> | undefined>(
        undefined
    );
    ...
    useStartMotion(currentElementMotion, (position) => setElementPosition(position!), endElementMotion);
