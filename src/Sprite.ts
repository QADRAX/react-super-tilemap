import { DEFAULT_ANIMATION_DELAY, DEFAULT_SPRITE_TILESIZE, DIFERENT_SIZE_ERROR, EMPTY_SPRITE_ERROR, INVALID_SPRITE_IMAGE_ERROR } from "./constants";
...
export class Sprite {
    ...
    constructor(
        ...
        this._animationDelay = this._imagesSrc.length > 1
            ? animationDelay
            : 0;

        if (spriteDefinition.tileSize
