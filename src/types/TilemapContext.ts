...
import { CameraMotionRequest, CameraMotion, ZoomMotionRequest, ZoomMotion, MotionSettings } from "./Motions";
...
export type ContextActions = {
     ...
     * @throws Error if the canvas has no size.
     */
    addCameraMotionCenteredOnTilePosition: (settings: MotionSettings, tilePosition: TilePosition) => void;
    /**
